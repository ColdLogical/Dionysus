...
public class WebOperation : NSObject, NSURLConnectionDataDelegate, NSURLConnectionDelegate {
        ...
        */
        ...
        :param: xmlDictionary         A Dictionary of keys and values that will be converted into an XML string representation and appended to the body of the request
        ...
        */
        ...
        /**
        Convience initializer that facilitates XML data into a PUT request.
